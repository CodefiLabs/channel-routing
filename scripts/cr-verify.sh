...
# cr-verify.sh — Delayed health check for a child session
# Usage: cr-verify.sh <slug> <chat_id>
# Designed to be run in background: cr-verify.sh slug chat_id &

SLUG="${1:?Usage: cr-verify.sh <slug> <chat_id>}"
